...
import { callAllEvents, callArtsAndTheater, callMusic, callSearchData, callSports, dateOptions } from "@/app/helperFunctions";
    ...
    useEffect(() => {
        async function callEvents() {
            ...
            switch(params.searchType) {
                case "Music":
                    await callMusic().then((e) => setData(e));
                    break;
                case "Sports":
                    await callSports().then((e) => setData(e));
                    break;
                case "Arts":
                    await callArtsAndTheater().then((e) => setData(e));
                    break;
                default:
                    await callAllEvents().then((e) => setData(e));
                    break;
            }
            //await callSearchData(params.searchType).then((e) => setData(e));
        }
